...
'',
'/* ==================== 悬浮卡片状态行增补（issue #4） ==================== */',
'/* 与宿主 .hoverStatus 行同构：flex 行 + 10px 状态点 + 12px 次要色文案。',
'   宿主卡片是深色浮层，故用固定亮色（与宿主 hover 文案一致），不随主题变量。 */',
'.ss-hover-status {',
'  display: flex; align-items: center; gap: 8px;',
...
'  background: #8b5cf6;',
'}',
'.ss-hover-status[data-state="urgent"] .ss-hover-status-dot { background: var(--dsw-alias-state-warn-secondary); }',
'.ss-hover-status[data-state="overdue"] .ss-hover-status-dot { background: var(--dsw-alias-state-error-primary); }',
'',
'/* ==================== 设置页（定时提醒卡片） ==================== */',
