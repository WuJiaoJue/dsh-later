...
export function recordOwnership(sessionId, id, delivery, uid) {
    ...
    const entry = nextUid !== undefined ? { delivery, createdAt: Date.now(), uid: nextUid } : { delivery, createdAt: Date.now() };
    entries[id] = entry;
