...
var COMPONENTS = [
  ...
  "}",
  "/* \u6682\u505C\uFF1A\u539F\u5730\u51BB\u7ED3\uFF08\u659C\u7EB9\u505C\u653E hatch\uFF09\u3002\u5BBD\u5EA6\u9501\u5728 remaining\uFF0C\u4E0D\u518D\u8D70 transition\u3002 */",
  ".ss-dock-row.ss-paused .ss-dock-bar-fill {",
  "  background:",
  "    repeating-linear-gradient(",
  "      115deg,",
  "      var(--dsw-alias-label-tertiary) 0 5px,",
  "      transparent 5px 10px",
  "    ),",
  "    var(--dsw-alias-line-secondary);",
  "  opacity: 0.9;",
  "  transition: none;",
  "}",
...
function TaskList({ items: items2, now, deliveredIds, cancellingIds, onDelete, timeZone, t, lang }) {
  if (items2.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ss-empty", "data-ss-empty": "", children: t.emptyTasks });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "ss-tasks", "data-ss-tasks": "", children: items2.map((item) => {
...
function showReminderToast(text, ttlMs = 5e3) {
  const id = nextId++;
  const item = { id, text };
  items = [...items, item];
  emit();
...
function useToasts() {
  const [state, setState] = (0, import_react7.useState)(items);
...
function ReminderToastHost() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "ss-toast-host", "data-ss-toast": "", children: toasts.map((item) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ss-toast", role: "status", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "ss-toast-icon", "aria-hidden": "true", children: "\u23F0" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "ss-toast-text", children: item.text })
  ] }, item.id)) });
}
var mounted = false;
function mountReminderToastHost() {
  ...
  root.render(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ReminderToastHost, {}));
  return () => {
    root.unmount();
    host.remove();
    mounted = false;
...
function barSegments(item, now, firstSeen) {
  ...
  let start;
  if (item.kind === "after" && item.after_seconds !== void 0) {
    start = end - item.after_seconds * 1e3;
  ...
  const totalMs = Math.max(1e3, end - start);
...
function frozenBarSegments(item, frozenLeftMs) {
  const totalMs = Math.max(1e3, (item.after_seconds ?? 0) * 1e3);
...
function ScheduleDock({ callCommand, sessionId, useProjection, locale }) {
  ...
  const projection = typeof useProjection === "function" ? useProjection("userSchedules") : void 0;
  const schedules = (0, import_react8.useMemo)(
  ...
  const [cancelling, setCancelling] = (0, import_react8.useState)(/* @__PURE__ */ new Set());
  const [editingId, setEditingId] = (0, import_react8.useState)(null);
  const [editingText, setEditingText] = (0, import_react8.useState)("");
  const [editErr, setEditErr] = (0, import_react8.useState)(null);
  const [saving, setSaving] = (0, import_react8.useState)(false);
  const [steering, setSteering] = (0, import_react8.useState)(/* @__PURE__ */ new Set());
  const [steerDone, setSteerDone] = (0, import_react8.useState)(/* @__PURE__ */ new Set());
  const [steerErr, setSteerErr] = (0, import_react8.useState)(/* @__PURE__ */ new Map());
  const [pausing, setPausing] = (0, import_react8.useState)(/* @__PURE__ */ new Set());
  const [resuming, setResuming] = (0, import_react8.useState)(/* @__PURE__ */ new Set());
  const [pauseErr, setPauseErr] = (0, import_react8.useState)(/* @__PURE__ */ new Map());
  const prevRef = (0, import_react8.useRef)(/* @__PURE__ */ new Map());
  const suppressedRef = (0, import_react8.useRef)(/* @__PURE__ */ new Set());
  const firstSeenRef = (0, import_react8.useRef)(/* @__PURE__ */ new Map());
  const byId = (0, import_react8.useMemo)(() => new Map(schedules.map((item) => [item.id, item])), [schedules]);
  ...
  const handleCancel = (id) => {
    suppress(id);
    setCancelling((current) => new Set(current).add(id));
    void callCommand(sessionId, deleteLine2(id)).finally(() => {
      window.setTimeout(() => {
        setCancelling((current) => {
  ...
  const handleSteer = (item) => {
    ...
    void callCommand(sessionId, steerLine(id)).then((ok) => {
      if (ok) {
  ...
  const handlePause = (item) => {
    ...
    void callCommand(sessionId, pauseLine(id)).then((ok) => {
      if (!ok) {
  ...
  const handleResume = (item) => {
    ...
    void callCommand(sessionId, resumeLine(uid)).then((ok) => {
      if (!ok) {
  ...
  const renderRow = (item) => {
    ...
    if (editingId === item.id) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("li", { className: "ss-dock-row ss-editing", "data-ss-dock-row": item.id, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "ss-dock-action", onClick: cancelEdit, "aria-label": t.editCancel, children: "\u2715" }),
        editErr !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-edit-err", children: editErr })
      ] }, item.id);
    }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-preview", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-row-line", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-row-time", children: formatHhmm(epoch, detectTimeZone()) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `ss-dock-row-countdown${!isPaused && state === "overdue" ? " ss-due" : ""}${isPaused ? " ss-paused-label" : ""}`, children: countdownText }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-row-prompt", title: item.prompt, children: item.prompt })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(MultiBar, { item, now, firstSeen: firstSeenRef.current, t, frozen: isPaused, frozenLeftMs: frozenLeft }),
            (steerErr.get(item.id) ?? pauseErr.get(item.id)) !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-steer-err", children: steerErr.get(item.id) ?? pauseErr.get(item.id) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueEditIcon, {})
              }
            ),
            isPaused ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueResumeIcon, {})
              }
            ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "button",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueuePauseIcon, {})
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "button",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueDeleteIcon, {})
              }
            ),
            item.kind !== "every" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueSendIcon, {})
              }
            )
          ] })
        ]
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "ss-dock-root", "data-ss-dock": "", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-body", children: [
    schedules.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-lead", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueClockIcon, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-count", children: format(t.panelCount, { n: schedules.length }) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: expanded ? "ss-dock-chevron ss-open" : "ss-dock-chevron", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(QueueChevronIcon, {}) })
        ]
      }
    ),
    expanded && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("ul", { className: "ss-dock-list", children: schedules.map(renderRow) })
  ] }) });
}
function MultiBar({
  item,
  ...
  const { totalRatio, count } = frozen ? frozenBarSegments(item, frozenLeftMs ?? 0) : barSegments(item, now, firstSeen);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-bar", children: [
        count > 1 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "div",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "ss-dock-bar-fill", style: { width: `${totalRatio * 100}%` } })
      ] })
    }
  );
}
...
function QueuePauseIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: "3.6", y: "2.6", width: "3.2", height: "10.8", rx: "1.1", fill: "currentColor" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: "9.2", y: "2.6", width: "3.2", height: "10.8", rx: "1.1", fill: "currentColor" })
  ] });
}
function QueueResumeIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M4.4 2.9c0-.6.66-1 1.18-.68l7.1 4.1c.52.3.52 1.06 0 1.36l-7.1 4.1A.8.8 0 0 1 4.4 11.1V2.9Z", fill: "currentColor" }) });
}
...
function ChevronDown({ className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", className, "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("path", { d: "M3.5 5.25 7 8.75l3.5-3.5", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }) });
}
function SchedulerSettingsCard({ scope, t }) {
  const [snapshot, setSnapshot] = (0, import_react9.useState)(() => scope.getSnapshot());
  const [pending, setPending] = (0, import_react9.useState)({});
  ...
  if (snapshot.status === "unavailable") return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, {});
  if (snapshot.status !== "ready") {
    if (snapshot.status === "loading") return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "ss-hint", children: t("loading") });
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "ss-hint", children: t("unavailable") });
  }
  ...
  const handleDiscard = (0, import_react9.useCallback)(() => {
    setPending({});
    setFailed(false);
  }, []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { className: open ? "ss-card ss-cardOpen" : "ss-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "ss-card-headText", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ss-card-name", children: t("title") }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ss-card-description", children: t("description") })
          ] }),
          dirty && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ss-card-pending", children: t("pendingBadge") }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ChevronDown, { className: open ? "ss-card-chevron ss-card-chevronOpen" : "ss-card-chevron" })
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ss-card-body", children: [
      !writable && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "ss-card-readOnly", role: "status", children: t("readOnly") }),
      FIELDS.map((field) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ss-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ss-card-fieldHead", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("label", { htmlFor: fieldId, className: "ss-card-label", children: t(labelKey) }),
            userHas && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "ss-card-badges", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ss-card-badge", children: t("overriddenLabel") }),
          ...
          field.kind === "boolean" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "select",
            {
              id: fieldId,
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "true", children: t("optionOn") }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "false", children: t("optionOff") })
              ]
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "input",
          ...
          invalid !== null || hintKey !== void 0 && t(hintKey).length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: invalid !== null ? "ss-card-invalid" : "ss-hint", children: invalid !== null ? invalid : t(hintKey) }) : null
        ] }, field.key);
      }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ss-card-footer", children: [
        failed && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "ss-card-failed", role: "status", children: t("saveFailed") }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
...
function summarizeSchedules(schedules) {
  ...
  return nextAt === void 0 ? { count: 0 } : { count, nextAt };
}
...
function mountSessionPresence(options) {
  ...
  function applyBadge(row, now, dict) {
    ...
    const aria = state === "overdue" ? format(dict.presenceOverdueAria, { n: entry.count }) : format(dict.presenceBadgeAria, { n: entry.count, time });
    const tooltip = state === "overdue" ? format(dict.presenceOverdueTooltip, { n: entry.count }) : format(dict.presenceTooltip, { n: entry.count, time });
    if (existing !== null) {
