...
function ScheduleDock({ callCommand, sessionId, useProjection, locale }) {
  ...
  const renderRow = (item) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("li", { className: "ss-dock-row", "data-ss-dock-row": item.id, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-preview", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "ss-dock-row-line", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `ss-dock-row-countdown${state === "overdue" ? " ss-due" : ""}`, children: state === "overdue" ? t.dueAnyMoment : `${t.countdownLeft} ${formatCountdown(epoch - now)}` }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-row-prompt", title: item.prompt, children: item.prompt })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(MultiBar, { item, now, firstSeen: firstSeenRef.current, t }),
        steerErr.get(item.id) !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "ss-dock-steer-err", children: steerErr.get(item.id) })
      ] }),
