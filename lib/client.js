...
var COMPONENTS = [
  ...
  "}",
  "/* \u6682\u505C\uFF1A\u539F\u5730\u51BB\u7ED3\uFF08\u659C\u7EB9\u505C\u653E hatch\uFF09\u3002\u8F68\u9053\u52A0\u5F3A\u53EF\u89C1\uFF1B\u586B\u5145\u9501\u5728\u51BB\u7ED3 elapsed\uFF0C\u4E0D\u518D transition\u3002 */",
  ".ss-dock-row.ss-paused .ss-dock-bar {",
  "  background:",
  "    repeating-linear-gradient(",
  "      115deg,",
  "      color-mix(in srgb, var(--dsw-alias-label-tertiary) 22%, transparent) 0 4px,",
  "      transparent 4px 8px",
  "    ),",
  ...
  "    repeating-linear-gradient(",
  "      115deg,",
  "      var(--dsw-alias-label-secondary) 0 5px,",
  "      transparent 5px 10px",
  "    ),",
  "    color-mix(in srgb, var(--dsw-alias-label-tertiary) 45%, var(--dsw-alias-line-secondary));",
  "  min-width: 4px;",
  "  opacity: 1;",
  "  transition: none;",
  "}",
...
function frozenBarSegments(item, frozenLeftMs) {
  const remainingSec = Math.max(0, item.remaining_seconds ?? Math.round(frozenLeftMs / 1e3));
  const windowSec = Math.max(item.after_seconds ?? 0, remainingSec, 1);
  const totalMs = windowSec * 1e3;
      ...
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ss-dock-preview", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MultiBar, { item, now, firstSeen: firstSeenRef.current, t, frozen: isPaused, frozenLeftMs: frozenLeft }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ss-dock-bar", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "ss-dock-bar-fill", style: { width: `${totalRatio * 100}%` } })
      ] })
    }
  );
}
